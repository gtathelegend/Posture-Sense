...
[![Tests Passing](https://img.shields.io/badge/tests-111%20passing-brightgreen.svg)](docs/TESTING.md)
...
- **Configurable Pose Recognition**: Matches 12 posture and yoga poses using threshold rules and stability hold timers.
...
├── tests/                    # Automated Test Suite (111 passing tests)
