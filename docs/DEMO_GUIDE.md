...
| **1:45 - 2:30** | **4. Pose Recognition & Biomechanics** | Slouch forward slightly, then sit up tall into Ergonomic posture. | "The BiomechanicsEngine calculates neck flexion and shoulder asymmetry in real-time. The PoseRuleEngine classifies upright ergonomic alignment." | Live neck angle shifts (e.g., 14.2°), pose card changes to **Upright Ergonomic (96%)**. |
