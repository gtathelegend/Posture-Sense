...
**Version:** 2.0.0  
**Test Suite Status:** 111 Passed / 0 Failed  
...
The test suite located under `tests/` contains **111 automated test cases**:
...
| [test_mediapipe_engine.py](file:///d:/Github/Posture-Sense/tests/test_mediapipe_engine.py) | WASM landmarker interface, keypoint parsing | 3 | PASSING |
| [test_landmark_engine.py](file:///d:/Github/Posture-Sense/tests/test_landmark_engine.py) | EMA smoothing, NaN validation, tracking loss recovery | 3 | PASSING |
