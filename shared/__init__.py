...
Provides contracts, event bus, config loading, plugin interfaces, constants, runtime, and utilities.
"""
...
from shared.core.runtime import EngineRuntime, EngineRegistry, LifecycleState, EngineDiagnostics
